...
public partial class interval : System.Web.UI.Page
{
    string sql = "";
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (tbname.Text == "")
            {
                lblerr.Text = "Please input Interval Name";
                return;
            }
            sql = "Insert into Interval (IntervalName) Values('" + tbname.Text + "')";
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sql = "Update Interval set IntervalName='" + tbname.Text + "' where IntervalID='" + tbid.Text + "'";
            if (obj.ExecuteSQL(sql))
            {
    ...
    protected void btndelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sql = "Delete from Interval where IntervalID='" + tbid.Text + "'";
            if (obj.ExecuteSQL(sql))
            {
