...
public partial class TankType : System.Web.UI.Page
{
    string sql = "";
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (tbname.Text == "")
            {
                lblerr.Text = "Please input Type Name";
                return;
            }
            sql = "Insert into TankType (TypeName) Values('" + tbname.Text + "')";
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sql = "Update TankType set TypeName='" + tbname.Text + "' where TypeID='" + tbid.Text + "'";
            if (obj.ExecuteSQL(sql))
            {
    ...
    protected void btndelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sql = "Delete from TankType where TypeID='" + tbid.Text + "'";
            if (obj.ExecuteSQL(sql))
            {
