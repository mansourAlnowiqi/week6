<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageadmin.master" AutoEventWireup="true" CodeFile="Area.aspx.cs" Inherits="Area" %>
               ...
               <tr>
                   ...
                   <td colspan="2" style="text-align: center">
                       <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                           ...
                           <Columns>
                               <asp:BoundField DataField="AreaID" HeaderText="Area ID" InsertVisible="False" 
