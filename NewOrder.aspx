<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageadmin.master" AutoEventWireup="true" CodeFile="NewOrder.aspx.cs" Inherits="NewOrder" %>
           ...
           <tr>
               ...
               <td>
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                       ...
                       SelectCommand="SELECT [SchID], [schDate], [TypeName], [AreaName], [OrderID], [OrderDate], [CustomerName], [Phone], [IntervalName] FROM [CustomerOrderData]">
                   </asp:SqlDataSource>
